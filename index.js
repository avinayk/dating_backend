...
const {
  router: adminloginRoutes,
  setWebSocketServerAdminMain,
} = require("./routes/admin");
const {
  router: adminsendnotificationRouter,
  setWebSocketServerAdminNotification,
} = require("./routes/adminsendnotification");
...
app.use("/api/adminsendnotification/", adminsendnotificationRouter);
//Admin
// Set the WebSocket server for members routes
setWebSocketServerAdminMain(wss);
setWebSocketServerAdminNotification(wss);
